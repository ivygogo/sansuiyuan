...
public class DBService {
  ...
  private static final String CREATE_Board =
      "CREATE TABLE `board` (  `Id` int NOT NULL AUTO_INCREMENT,  `Class` varchar(5) COLLATE"
          ...
          + " DEFAULT NULL COMMENT '預設1可留言,房東可關閉',  `Poster_Id` int DEFAULT NULL COMMENT 'fk', "
  ...
  private static final String CREATE_Chatroom =
      "CREATE TABLE `chatroom` (  `Cid` int NOT NULL AUTO_INCREMENT,  `Member1` int NOT NULL, "
          + " `Member2` int NOT NULL,  `CREATE_Time` datetime DEFAULT NULL COMMENT '此欄位是指聊天室成立的時間',"
          + "  `IsOpen` tinyint DEFAULT NULL,  `ValidTime` datetime NOT NULL COMMENT '關閉時間\\n"
          + "\"如果是報修：修復完成後+24hrs?\\n"
          + "如果是預約取消：取消時間+24hrs\\n"
          + "如果是預約：看房時間+14days\\n"
          + "如果被室友婉拒，則立即invalid?\"',  PRIMARY KEY (`Cid`,`Member1`,`Member2`)) ENGINE=InnoDB"
  ...
  private static final String CREATE_Member =
      "CREATE TABLE `member` (  `UId` int NOT NULL DEFAULT '1',  `Name` varchar(10) CHARACTER SET"
          ...
          + " utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '身分證',  `Mail` varchar(45)"
          ...
          + " '1' COMMENT '1是表是目前帳號狀態:開通\\n"
          + "0表示表示未開通\\n"
          + "\\n"
          + "留著做以後,若是註冊時需要驗證信箱用,如果這樣的default要改成0',  `Code` varchar(6) CHARACTER SET utf8mb4 COLLATE"
          + " utf8mb4_0900_ai_ci DEFAULT NULL COMMENT '驗證時的密碼',  `School` varchar(10) CHARACTER SET"
  ...
  private static final String CREATE_Property_Management =
      "CREATE TABLE `property_management` (  `UId` int NOT NULL DEFAULT '1',  `Name` varchar(10)"
          ...
          + " '公司章 link',  PRIMARY KEY (`UId`),  UNIQUE KEY `UId_UNIQUE` (`UId`),  UNIQUE KEY"
          + " `Password_UNIQUE` (`Password`),  UNIQUE KEY `Mail_UNIQUE` (`Mail`)) ENGINE=InnoDB"
          + " DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='物業資訊'";
  ...
  private static final String CREATE_Roomtype =
      "CREATE TABLE `roomtype` (  `Rid` int NOT NULL,  `name` varchar(2) CHARACTER SET utf8mb4"
          ...
          + " COMMENT '該房型的總共數量',  `Price` int DEFAULT NULL,  `Size` decimal(3,1) DEFAULT NULL, "
          ...
          + " utf8mb4_0900_ai_ci DEFAULT NULL COMMENT '格局link',  `Q_TV` int DEFAULT '1', "
          ...
          + " DEFAULT NULL,  `Q_Windows_Screen_G` int DEFAULT NULL COMMENT '落地紗窗',  `Q_Wardrobe`"
  ...
  private static final String CREATE_Store =
      "CREATE TABLE `store` (  `Uid` int NOT NULL,  `Name` varchar(45) CHARACTER SET utf8mb4"
          ...
          + "連結字串，指定到某個圖片檔，沒有圖片需指到預設圖片',  `Describe` varchar(500) CHARACTER SET utf8mb4 COLLATE"
          + " utf8mb4_0900_ai_ci DEFAULT NULL,  `Conclusion_Link` varchar(45) CHARACTER SET utf8mb4"
          + " COLLATE utf8mb4_0900_ai_ci DEFAULT NULL COMMENT '連結字串？',  `Order` int DEFAULT NULL"
          + " COMMENT '1/2/3，如果有兩則都是1，則以上架時間愈新的為主',  `IsShow` tinyint DEFAULT NULL,  `Publish_Time`"
          + " datetime DEFAULT NULL,  `Unpublish_Time` datetime DEFAULT NULL COMMENT '空白表示：永遠上架', "
          ...
          + " CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='商家'";
