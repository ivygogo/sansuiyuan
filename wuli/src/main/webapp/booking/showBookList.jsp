						...
						<c:forEach var="booker" items="${bookingService.allBookers}">
							<tr align="center">
								...
								<td class="class${booker.bookerId}"><input type="hidden"
									name="bookDate" id="bookDate" value="${booker.bookDate}">
									<input class="datepicker" type="text"
									value=<c:out value='${booker.bookDate}'/>></td>

								<td class="class${booker.bookerId}"><input type="hidden"
									name="preferTime" id="preferTime" value="${booker.preferTime}">
								...
								<td>
									<div class="submit class${booker.bookerId}">修改</div> <!--                <input type="submit" -->
		...
		xx[i]
				.addEventListener(
						...
						function(e) {
							...
							//                  + '-----------------------------');
							document.getElementById("bookerId").value = t
									.replace(/[^\d]/g, "");
