...
<body>
	<div style="position: relative;">
		<img src='<c:url value="/icon.jpg" ></c:url>' width="100" height="50">
		<div style="position: absolute; display: inline-block; right: 150px;">

		</div>
		<div style="position: absolute; right: 0; top: 0;">
			<img src='<c:url value="/user.png" ></c:url>' width="40" height="40">
	...
	<div style="position: relative; margin-top: 20px">
		<div style="position: absolute; left: 400px;" id="refresh">
			<img src='<c:url value="/refresh.png" ></c:url>' width="30" height="30" style="cursor: pointer; display: inline; top: 200px;" onclick="window.location.reload();">
			<p style="cursor: pointer; display: inline; font-size: 30px;">Refresh</p>
		</div>
		<div style="position: absolute; left: 600px; margin-top: 5px">
			<img src='<c:url value="/undo.png" ></c:url>' width="30" height="30" style="top: 200px;">
		</div>


		<form action="Update" method="post" name="delete">
			<div style="position: absolute; left: 700px; margin-top: 5px">
				<input type="image" src='<c:url value="/trash.png" ></c:url>' style="top: 200px; cursor: pointer; width: 30px; height: 30px;" id="hide" > 
			        <input type="hidden" name="selects" value="" id="formUpdate">  
			</div>
		</form>


		<div style="position: absolute; left: 800px; margin-top: 5px">
			<img src='<c:url value="/bookmark.png" ></c:url>' width="30"
				height="30" style="top: 200px;">
		</div>
		<div style="position: absolute; left: 900px; margin-top: 5px">
			<img src='<c:url value="/edit.png" ></c:url>' width="30" height="30"
				style="top: 200px;">
		</div>
		<div style="position: absolute; right: 500px; margin-top: 5px;">
			<form action="" style="display: inline;">
				<span style="display: inline; font-weight: bold; font-size: 20px">關鍵字</span><input
					style="width: 250px; height: 30px;" type="text">
			</form>
		</div>
		<div style="position: absolute; right: 450px; margin-top: 6px;">
			<img src='<c:url value="/search.png" ></c:url>' width="30"
				height="30">
		</div>
	...
	<div id="status" class="overflow-auto"
		style="margin-top: 50px; border-radius: 40px;">
		<div
			style="position: absolute; height: 30px; width: 1450px; margin-top: 20px">
			<div style="position: absolute;">
				<form action="">
					...
					<div>
						<select
							style="display: inline; position: absolute; left: 20px; top: 3px; font-size: 16px;">
							<option >合約狀態</option>
							<option>租賃中</option>
							<option>已退租</option>
							<option>租約到期</option>
			...
			<div style="position: absolute; left: 150px; font-size: 16px;">
				<p style="display: inline;">合約編號</p>
			</div>
			<div style="position: absolute; left: 300px; font-size: 16px;">

				<p style="display: inline;">租客姓名</p>
			</div>
			...
			<div style="position: absolute; left: 1200px;">
				<form action="">
					<select style="font-size: 16px;">
						<option>合約.pdf</option>
					</select>
				</form>
			</div>
			<div style="position: absolute; left: 1350px;">
				<form action="">
					<select style="font-size: 16px;">
						<option>簽約日期</option>
					</select>
		...
		<c:forEach var="contract" items="${allContract}">
			...
			<form style="display: inline;" >
				...
				<div style="position: relative; display: inline; margin-left: 15px;">
					<input type="text" value="${contract.status}" id="status${contract.CID}" style="display: none;" class="ST">
					<p style="display: inline;">${contract.status}</p>
				</div>
				<div style="position: relative; display: inline; margin-left: 85px;">${contract.CID}
					<input type="hidden" value="${contract.CID}" id="CID${contract.CID}">
				</div>
				<div style="position: relative; display: inline; margin-left: 113px;">
					<input type="text" value="${contract.name}" id="name${contract.CID}" style="display: none;" class="nickName">
					<p style="display: inline;">${contract.name}</p>
				</div>
				<div style="position: relative; display: inline; margin-left: 90px;">${contract.room_Number}
					<input type="hidden" value="${contract.room_Number}" id="room_Number${contract.CID}" class="roomNumber">
				</div>
				<div
					style="position: relative; display: inline; margin-left: 108px;">${contract.room_Type}</div>
				<div
					style="position: relative; display: inline; margin-left: 125px;">${contract.payment_Status}
					<input type="hidden" value="${contract.payment_Status}" id="payment_Status${contract.CID}" class="PS">
				</div>
				<div
					style="position: relative; display: inline; margin-left: 108px;">${contract.check_Fee}
					<input type="hidden" value="${contract.check_Fee}" id="check_Fee${contract.CID}" class="CheckFee">
				</div>
				<div
					style="position: relative; display: inline; margin-left: 100px;">${contract.check_Status}
					<input type="hidden" value="${contract.check_Status}" id="check_Status${contract.CID}" class="CS">
				</div>
				...
				<div style="position: relative; display: inline; margin-left: 50px;">${contract.PDF}</div>
				<input type="hidden" value="${contract.PDF}" id="PDF${contract.CID}" class="pdf">

				<div style="position: relative; display: inline; margin-left: 80px;">${contract.signed_Date}</div>
				<input type="hidden" value="${contract.signed_Date}">
	...
	<div
		style="position: relative; border: 1px solid green; height: 800px; width: 1450px; left: 220px; border-radius: 50px;">
		...
		<div style="position: relative; padding: 30px;">
			...
			<form action="modify" style="display: inline;" method="post" name="formModify">
				<div id="checkboxgroup1">
					...
					<input type="checkbox" id="cks1" value="${contractS.cbs1.status}" class="status" onclick="return false;">租賃中 
					<input type="checkbox" id="cks2" value="${contractS.cbs2.status}" class="status" onclick="return false;">已退租 
					<input type="checkbox" id="cks3" value="${contractS.cbs3.status}" class="status" onclick="return false;">租約到期 
					<img src='<c:url value="/edit.png" ></c:url>'style="width: 30px; height: 30px; display: inline; margin-left: 900px; margin-bottom: 17px; cursor: pointer;"id="edit"> 
				    <input type="image" id="save" src='<c:url value="/save.png" ></c:url>' style="width: 30px; height: 30px; cursor: pointer; display: inline; margin-left: 50px;">
				</div>
				<script>$('#checkboxgroup1 input').click(function(){
					if($(this).prop('checked'))
					{$('#checkboxgroup1 input:checkbox').prop('checked',false);
				...
				<input type="text" id="input2" disabled="disabled"value="" name="PDF"  style="border: none; width: 130px; height: 30px; background-color: white; display: inline;">

				<img src='<c:url value="/clip.png" ></c:url>' width="20" height="20" id="clip"style="display: inline; margin-left: 0px">
				<div>
					<p style="display: inline; margin-top: 15px; margin-bottom: 10px;">房號:</p>
					<input type="text" id="input3" disabled="disabled" name="room_Number" value="" style="border: none; width: 100px; height: 30px; background-color: white; display: inline;">
				</div>
				<div id="checkboxgroup2">
					<p style="display: inline;">繳費狀態 :</p>
					<input type="checkbox" id="ckps1" class="payment_status" value="${contractPS.cbps1.payment_Status}"> 已繳 
					<input type="checkbox" id="ckps2" class="payment_status" value="${contractPS.cbps2.payment_Status}"> 未繳
					<input type="hidden" id="ContractPayment_status" name="payment_Status" value="">
				</div>
				<script>$('#checkboxgroup2 input').click(function(){
					if($(this).prop('checked'))
				...
				<div>
					...
					<input type="text" id="input4" disabled="disabled" value=""  name="deposit"style="border: none; width: 100px; height: 20px; background-color: white; display: inline;">
				</div>

				<div>

					<p style="display: inline; margin-top: 15px; margin-bottom: 10px;">費用結算:</p>
					<input type="text" id="input5" disabled="disabled" name="check_Fee" value="" style="border: none; width: 65px; height: 30px; background-color: white; display: inline;">
					<input type="checkbox"> 電費 
					<input type="checkbox" style="margin-left: 10px;">其他
				</div>


				<div style="position: absolute; display: block; margin-top: 5px;" id="checkboxgroup3">
					<p style="display: inline;">退租點交:</p>
					<input type="checkbox" id="ckcs1" class="check_status" value="${contractCS.cbcs1.check_Status}" > 未點交 
					<input type="checkbox" id="ckcs2" class="check_status" value="${contractCS.cbcs2.check_Status}"> 已點交
					<input type="hidden" id="ContractCheck_status" name ="check_Status" value="">
				</div>
				<script>$('#checkboxgroup3 input').click(function(){
					if($(this).prop('checked'))
					{$('#checkboxgroup3 input:checkbox').prop('checked',false);
					$(this).prop('checked',true)}});
			    </script>
			</form>
	...
	function test() {
		...
		for(let i = 0 ; i<ck.length;i++){
			...
			checkbox.addEventListener("click",function(e){
				...
				console.log(index  + " -- " + " -- " + number + " -- " + " -- --" + e.target.value)
				if(index!== -1){
