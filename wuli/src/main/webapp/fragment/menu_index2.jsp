								...
								<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
									<ul class="nav nav-tabs notika-menu-wrap menu-it-icon-pro">
										...
										<li class="active"><a data-toggle="tab"
											href='<c:url value="/rent.jsp"/>'><i
												class="notika-icon notika-house"></i>房契管理</a></li>
										<li><a data-toggle="tab"
											href='<c:url value="/Contract.do"/>'><i
												class="notika-icon notika-mail"></i>合約查詢</a></li>
										<li><a data-toggle="tab" href="#Interface"><i
												class="notika-icon notika-edit"></i>行事曆</a></li>
										<li><a data-toggle="tab"
											href='<c:url value="/bookinglist.jsp"/>'><i
												class="notika-icon notika-bar-chart"></i>預約管理</a></li>
										<li><a data-toggle="tab"
											href='<c:url value="/lanlordRepairForm.jsp"/>'><i
												class="notika-icon notika-windows"></i>報修管理</a></li>
										<li><a data-toggle="tab"
											href='<c:url value="/chatRoom.jsp"/>'><i
												class="notika-icon notika-form"></i>聊天室</a></li>
										<li><a data-toggle="tab"
											href='<c:url value="/memberInfo.jsp"/>'><i
												class="notika-icon notika-app"></i>物業資訊</a></li>
										<li><a data-toggle="tab"
											href='<c:url value="/login/login.jsp"/>'><i
												class="notika-icon notika-support"></i>登入</a></li>
									</ul>
...
<div class="mobile-menu-area">
	<div class="container">
		<div class="row">
            ...
            src='<c:url value="/images/contractQueryImg/icon.png" ></c:url>'
            width="100" height="50"></li>
							<li><a data-toggle="collapse" data-target="#Charts" href='<c:url value="/rent.jsp"/>'>房契管理</a></li>
							...
							<li><a data-toggle="collapse" data-target="#demo" href='<c:url value="/chatRoom.jsp"/>'>聊天室</a></li>
							<li><a data-toggle="collapse"
								data-target="#Miscellaneousmob" href='<c:url value="/memberInfo.jsp"/>'>物業資訊</a></li>
