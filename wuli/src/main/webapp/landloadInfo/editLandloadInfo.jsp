...
$.getJSON('LandloadInfo.do').then(res => {    
    ...
    landloadDistrict += res.resultData.district;
    
    $("#zipzip").twzipcode('set', {
        'county': landloadCounty,
        'district': landloadDistrict,
        
    });
    
    $('.selectpicker').selectpicker('refresh');
    $("input[name='landloadAddress']").val(res.resultData.address);
    $("input[name='landloadMail']").val(res.resultData.mail);
