...
import tw.edu.ntut.sce.java18.landlord.service.LanlordInfoService;
...
public class LandloadInfoServlet extends HttpServlet {
  ...
  protected void doGet(HttpServletRequest request, HttpServletResponse response)
    ...
    var landloadInfo = new LanlordInfoService().queryLandlordInfoByPrimaryKey(1);

    String imgPath =
        "C:\\_SpringBoot\\workspace\\sansuiyuan\\wuli\\src\\main\\webapp\\file\\temp\\"
            + landloadInfo.getStamp();
  ...
  protected void doPost(HttpServletRequest request, HttpServletResponse response)
    ...
    LanlordInfoService lanlordInfoService = new LanlordInfoService();
    ...
    if (parts != null) {
      ...
      for (Part p : parts) {
        ...
        if (p.getContentType() == null) {
          ...
          System.out.println("tampFilename:  --->" + tampFilename);
          System.out.println("num:  --->" + num);
          ...
          if (num == 0) {
            ...
            // System.out.println("oring:" + imgMimeType);
    ...
    if (!errList.isEmpty()) {
      ...
      lanlordInfoService.updateLandlordInfo(newBean);
      response.sendRedirect("memberInfo.jsp");
      //      RequestDispatcher rd = request.getRequestDispatcher("memberInfo.jsp");
      //      rd.forward(request, response);
      return;
  ...
  public String saveImage(final String tampFileBase64, final String fileName, int uid)
    ...
    /*======== 1.建立目錄 ===========*/
    File filePath =
        new File("C:\\_SpringBoot\\workspace\\sansuiyuan\\wuli\\src\\main\\webapp\\file\\stamps");
    if (!filePath.exists()) {
      filePath.mkdir();
    }
