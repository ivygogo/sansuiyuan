...
<div class="row mb-1 mt-5 ml-3">
	<div class="col-md-12 text-left">
		<div class="" style="display: flex; justify-content: center;">
			<h2 class="text-black mb-4">valid報修單</h2>
		</div>
	</div>
</div>
			...
			<div class="col">
				...
				<div class="row mt-5">
					...
					<div class="col">
						...
						<h3 class="text-black-opacity-05" id="repairFormCreateTime">${createTime}</h3>
						<input type="text" id="formCreateTime" value="date"
							name="formCreateTime" hidden />
					</div>
				</div>
