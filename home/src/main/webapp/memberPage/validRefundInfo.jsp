...
<section class="site-section" id="about-section">
	<form name="refundInfo"
		action="<c:url value="/MemberRefundAccountUpdate.do"/>" method="post"
		class="bg-white" enctype="multipart/form-data">

		<div class="row lg-mx-5">
			<div class="col lg-mx-5 "></div>
		</div>
		<br>
		<div class="container px-5 border">
			<div class="row lg-mx-5">
				<div class="col lg-mx-5 ">
					<div class="" style="display: flex; justify-content: center;">
						<h4 class="text-black mt-5">退款帳戶資訊vild</h4>
					</div>
					<div class="" style="display: flex; justify-content: center;">
			...
			<div class="row lg-mx-5 mt-5">
				...
				<div class="col lg-mx-5 ">
					...
					<c:choose>
						<c:when test="${ErrMsg.errRefundBank!=null}">
							<input type="text" id="fname" name="refundBank"
								class="form-control is-invalid col-12 mx-4"
								value="${param.refundBank}" >
				...
				<div class="col lg-mx-5 ">
					...
					<c:choose>
            <c:when test="${ErrMsg.errRefundBankstore!=null}">
              <input type="text" id="fname" name="refundBankstore"
                class="form-control is-invalid col-12 mx-4"
                value="${param.refundBankstore}" required>
              <div class="invalid-feedback mx-4">${ErrMsg.errRefundBankstore}</div>
            </c:when>

            <c:otherwise>
              <input type="text" name="refundBankstore"
                class="form-control is-invalid col-12 mx-4"
                value="${RefundBankstore}" required>
            </c:otherwise>
          </c:choose>
			...
			<div class="row lg-mx-5 my-4">
				<div class="col lg-mx-5">
					...
					<c:choose>
            <c:when test="${ErrMsg.errRefundName!=null}">
              <input type="text" id="fname" name="refundName"
                class="form-control is-invalid col-12 mx-4"
                value="${param.refundName}" required>
              <div class="invalid-feedback mx-4">${ErrMsg.errRefundName}</div>
            </c:when>

            <c:otherwise>
              <input type="text" name="refundName"
                class="form-control is-invalid col-12 mx-4"
                value="${RefundName}" required>
            </c:otherwise>
          </c:choose>
				...
				<div class="col lg-mx-5">
					...
					<c:choose>
            <c:when test="${ErrMsg.errBankAccount!=null}">
              <input type="text" id="fname" name="bankAccount"
                class="form-control is-invalid col-12 mx-4"
                value="${param.bankAccount}" required>
              <div class="invalid-feedback mx-4">${ErrMsg.errBankAccount}</div>
            </c:when>
