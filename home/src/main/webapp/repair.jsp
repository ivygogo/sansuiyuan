...
<script type="text/javascript">
	...
	function updateRepairPage(i) {
		...
		if (i == 0) {
			$('#repairFormPage').html("");
			$('#repairFormPage').load('memberPage/insertRepairForm.jsp',
					function() {
						$('#newRepairBtn').hide();
					});
...
<body data-spy="scroll" data-target=".site-navbar-target"
		...
		<section class="login-block">
			<div class="container mt-5 mb-5">
				...
				<div class="row mb-1 border-bottom ">
					...
					<div class="col-md-2 text-left " id="newRepairBtn"
						style="visibility: hidden">
						<button class="btn btn-repair" onclick="updateRepairPage(0)">新增維修單資訊</button>
					</div>
	...
	<script>
		...
		if (valid === "editRepairForm" && ridState === "others") {
			...
			$('#repairFormPage').html("");
			$('#repairFormPage').load('memberPage/listRepairForm.jsp',
					function() {
						showFirst();
					});
