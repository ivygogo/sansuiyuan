          ...
          <div class="card-body p-4 p-md-5">
            ...
            <form method="POST" action="<c:url value='/register/register.do' />" >
              ...
              <div class="mt-4 pt-2" align="center">
                <input type="reset" name="cancel" id="cancel" value="重填" class="btn btn-primary btn-lg"/>
                <input type="submit" name="submit" id="submit" value="註冊" class="btn btn-primary btn-lg"/>
              </div>
