...
<head>
  <link rel='stylesheet'
        href='${pageContext.request.contextPath}/css/bookinglist.css'
        type="text/css"/>
  <link rel="stylesheet"
...
<div id="booklist">
  ...
  <!-- <Form Action="booking.do" method="POST"> -->
    ...
    <p/>姓名: <input type="text" id="bookerName" name="bookerName"
               value="${LoginOK.name}" readonly="readonly" style="color:#035afc">
    <%--       <div style="color:#FF0000; font-size:x-small; display: inline">${ErrorMsg.bookerName}</div> --%>
    <p/>
    帳號: <input type="text" name="bookerId" value="${LoginOK.uId}" readonly="readonly" style="color:#035afc">
    <%--       <div style="color:#FF0000; font-size:x-small; display: inline">${ErrorMsg.bookerId}</div> --%>
    <p/>
    電話: <input type="text" name="bookerPhone" value="${LoginOK.phone}" readonly="readonly" style="color:#035afc">
    <div style="color: #FF0000; font-size: x-small; display: inline">${ErrorMsg.bookerPhone}</div>
    <p/>
    房型: <input type="text" name="roomtype" id="booking-room-type"
               value="">
    <div style="color: #FF0000; font-size: x-small; display: inline">${ErrorMsg.roomtype}</div>
    <P/>
    樓層: <select name="preferFloor" size="1" id="preferFloor"
                onChange="change()">
    ...
    <p/>
    日期: <input id="datepicker" type="text" name="bookDate">
    <div style="color: #FF0000; font-size: x-small; display: inline">${ErrorMsg.bookDate}</div>
    <P/>
    時段: <select id="preferTime" name="preferTime" size="1"
                onChange="change()">
  ...
  <small><a href="http://localhost:8080/home/">回首頁</a>
  </small>
</div>
</body>
