...
import tw.edu.ntut.sce.java18.tenant.memberInfo.dao.impl.AvatarDaoImpl;
import tw.edu.ntut.sce.java18.tenant.memberInfo.dao.impl.CharacterAndFavorDaoImpl;
import tw.edu.ntut.sce.java18.tenant.memberInfo.dao.impl.GuarantorDaoImpl;
import tw.edu.ntut.sce.java18.tenant.memberInfo.dao.impl.MemberDaoImpl_jdbc;
...
public class MemberInfoServiceImpl implements MemberInfoService {
  ...
  public String checkIdNumber(String formValue, int genderId) {
    String errMsg = mbDao.checkIdNumber(formValue, genderId);
    return errMsg;
  }
